...
def get_latest_model_version(model_name):
    try:
        ...
        print(f"Warning: Could not fetch model version from MLflow: {e}")
        return None

model_version = get_latest_model_version(model_name)

# Try to load model from MLflow, fall back to local pickle file
if model_version:
    ...
    print(f"Model '{model_name}' not found in MLflow registry. Loading local model file...")
    model = pickle.load(open('models/model.pkl', 'rb'))
...
def predict():
    ...
    # Convert to features without preprocessing (vectorizer expects raw text)
